...
class FishingScene: SKScene {
    ...
    func setupBackground() {
        background = SKSpriteNode(imageNamed: "\(BackgroundStorage.shared.selectedBackground)")
    ...
    func setupFisherman() {
        fisherman = SKSpriteNode(imageNamed: "\(FishermanStorage.shared.selectedFisherman)")
