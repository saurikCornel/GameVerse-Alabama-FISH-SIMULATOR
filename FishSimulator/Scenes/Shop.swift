...
struct Shop: View {
    ...
    func returnFishermanState(forName name: String, price: Int) -> ItemState {
        if FishermanStorage.shared.selectedFisherman == name {
            return .used
        } else if FishermanStorage.shared.purchasedFishermans.contains(name) {
            return .available
        } else {
            return .price(price)
        }
    ...
    func returnBackgroundState(forName name: String, price: Int) -> ItemState {
        if BackgroundStorage.shared.selectedBackground == name {
            return .used
        } else if BackgroundStorage.shared.purchasedBackgrounds.contains(name) {
            return .available
        } else {
            return .price(price)
        }
                            ...
                            HStack {
                                ShopItem(
                                    ...
                                    case .used:
                                        return
                                    case .available:
                                        FishermanStorage.shared.selectFisherman(named: "fisherman_default")
                                    case .price(let price):
                                        guard price < coins else { return }
                                        coins -= price
                                        FishermanStorage.shared.purchaseFisherman(named: "fisherman_default")
                                    }
                                }
                                ShopItem(
                                    ...
                                    case .used:
                                        return
                                    case .available:
                                        FishermanStorage.shared.selectFisherman(named: "fisherman_buffalo")
                                    case .price(let price):
                                        guard price < coins else { return }
                                        coins -= price
                                        FishermanStorage.shared.purchaseFisherman(named: "fisherman_buffalo")
                                    }
                                }
                                ShopItem(
                                    ...
                                    case .used:
                                        return
                                    case .available:
                                        FishermanStorage.shared.selectFisherman(named: "fisherman_shaman")
                                    case .price(let price):
                                        guard price < coins else { return }
                                        coins -= price
                                        FishermanStorage.shared.purchaseFisherman(named: "fisherman_shaman")
                                    }
                                }
                            }
                            HStack {
                                ShopItem(
                                    ...
                                    case .used:
                                        return
                                    case .available:
                                        FishermanStorage.shared.selectFisherman(named: "fisherman_warrior")
                                    case .price(let price):
                                        guard price < coins else { return }
                                        coins -= price
                                        FishermanStorage.shared.purchaseFisherman(named: "fisherman_warrior")
                                    }
                                }
                                ShopItem(
                                    ...
                                    case .used:
                                        return
                                    case .available:
                                        FishermanStorage.shared.selectFisherman(named: "fisherman_chief")
                                    case .price(let price):
                                        guard price < coins else { return }
                                        coins -= price
                                        FishermanStorage.shared.purchaseFisherman(named: "fisherman_chief")
                                    }
                                }
                            }
                        }
                            ...
                            HStack {
                                ShopItem(
                                    ...
                                    case .used:
                                        return
                                    case .available:
                                        BackgroundStorage.shared.selectBackground(named: "river_day")
                                    case .price(let price):
                                        guard price < coins else { return }
                                        coins -= price
                                        BackgroundStorage.shared.purchaseBackground(named: "river_day")
                                    }
                                }
                                ShopItem(
                                    ...
                                    case .used:
                                        return
                                    case .available:
                                        BackgroundStorage.shared.selectBackground(named: "river_night")
                                    case .price(let price):
                                        guard price < coins else { return }
                                        coins -= price
                                        BackgroundStorage.shared.purchaseBackground(named: "river_night")
                                    }
                                }
                                ShopItem(
                                    ...
                                    case .used:
                                        return
                                    case .available:
                                        BackgroundStorage.shared.selectBackground(named: "deep_ocean")
                                    case .price(let price):
                                        guard price < coins else { return }
                                        coins -= price
                                        BackgroundStorage.shared.purchaseBackground(named: "deep_ocean")
                                    }
                                }
                            }
                            HStack {
                                ShopItem(
                                    ...
                                    case .used:
                                        return
                                    case .available:
                                        BackgroundStorage.shared.selectBackground(named: "river_sunset")
                                    case .price(let price):
                                        guard price < coins else { return }
                                        coins -= price
                                        BackgroundStorage.shared.purchaseBackground(named: "river_sunset")
                                    }
                                }
                            }
                        }
